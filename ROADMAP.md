...
2. **V2.2 — Workspaces** · Frei anlegbare Workspaces („Aditor", „Content"), Switcher in der Sidebar, Boards verschiebbar; Migration ordnet Bestand „Aditor" zu. Unabhängig von V2.1 baubar. → Spec: [docs/superpowers/specs/2026-07-21-v2-workspaces-design.md](docs/superpowers/specs/2026-07-21-v2-workspaces-design.md) · **Fertig wenn:** Build + `scripts/smoke-workspaces.mjs` + Playwright-Move-Smoke grün; kein Board ohne `workspace_id`; Screenshots.
3. **V2.3 — Studio-Modus** ⚠️ *erst starten, wenn V2.1 gemergt ist (braucht tldraw v3)* · Frames als Szenen mit Szenen-Panel, Studio-Modus (alles ausgeblendet, sanfte Kamerafahrten, Laser), Facecam-Bubble fürs externe Recording. → Spec: [docs/superpowers/specs/2026-07-21-v2-studio-mode-design.md](docs/superpowers/specs/2026-07-21-v2-studio-mode-design.md) · **Fertig wenn:** Build + `scripts/smoke-scenes.mjs` + Playwright-Smokes (Chrome-Hide, Fake-Camera) grün; Screenshots inkl. Bubble.
